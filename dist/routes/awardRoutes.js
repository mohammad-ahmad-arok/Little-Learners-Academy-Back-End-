...
router.post("/", multerConfig_1.default.single('icon'), awardController_1.createAward); // Create a new award
router.put("/:id", multerConfig_1.default.single('icon'), awardController_1.updateAward); // Update an award by ID
