...
router.post("/", multerConfig_1.default.single('image'), (0, uploadImageMiddlware_1.default)("image"), awardValidator_1.createAwardValidator, awardController_1.createAward); // Create a new award
router.put("/:id", multerConfig_1.default.single('image'), (0, uploadImageMiddlware_1.default)("image"), awardValidator_1.updateAwardValidator, awardController_1.updateAward); // Update an award by ID
