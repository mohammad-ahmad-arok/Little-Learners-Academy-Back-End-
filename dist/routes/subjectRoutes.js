...
exports.subjectRouter
    .route("/")
    .get(subjectController_1.getAllSubjects)
    .post(upload.single("image"), (0, uploadImageMiddlware_1.default)("image"), subjectValidator_1.createSubjectValidator, subjectController_1.createSubject);
exports.subjectRouter
    .route("/:id")
    .get(subjectValidator_1.getSubjectValidator, subjectController_1.getSubject)
    .put(upload.single("image"), (0, uploadImageMiddlware_1.default)("image"), subjectValidator_1.updateSubjectValidator, subjectController_1.updateSubject)
    .delete(subjectValidator_1.deleteSubjectValidator, subjectController_1.deleteSubject);
