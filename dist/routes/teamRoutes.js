...
router.post('/', multerConfig_1.default.single('photo'), (0, uploadImageMiddlware_1.default)("photo"), teamController_1.createTeamMember); // 'photo' is the form field name for the image
// Update a team member by ID with image upload (PUT)
router.put('/:id', multerConfig_1.default.single('photo'), (0, uploadImageMiddlware_1.default)("photo"), teamController_1.updateTeamMember);
