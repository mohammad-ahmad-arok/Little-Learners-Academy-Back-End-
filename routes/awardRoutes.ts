...
router.post("/", upload.single('image'),uploadImage("image"),createAwardValidator, createAward); // Create a new award
router.put("/:id", upload.single('image'),uploadImage("image"),updateAwardValidator, updateAward); // Update an award by ID
